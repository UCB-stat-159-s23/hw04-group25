...
html_baseurl = ''
html_favicon = ''
html_logo = 'berkeley-logo-claw.png'
html_sourcelink_suffix = ''
html_theme = 'sphinx_book_theme'
html_theme_options = {'search_bar_text': 'Search this book...', 'launch_buttons': {'notebook_interface': 'jupyterlab', 'binderhub_url': 'https://mybinder.org/v2/gh/UCB-stat-159-s23/hw04-group25/HEAD?urlpath=LOSC_Event_tutorial.ipynb', 'jupyterhub_url': '', 'thebe': False, 'colab_url': ''}, 'path_to_docs': '', 'repository_url': 'https://github.com/UCB-stat-159-s23/hw04-group25', 'repository_branch': 'main', 'extra_footer': '', 'home_page_in_toc': True, 'announcement': '', 'analytics': {'google_analytics_id': ''}, 'use_repository_button': True, 'use_edit_page_button': False, 'use_issues_button': True}
html_title = 'Homework No 4 - From Notebooks to Research Packages'
